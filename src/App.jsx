  ...
  return (
    <>
      <div className='flex p-6  text-2xl'>
          ...
          <div className='flex border-solid border-b border-gray-200'>
            ...
            <div  className=''>
              ...
              <div className='flex justify-between items-start  '>
                ...
                <div className=''>
                  <button className='bg-blue-400 rounded-3xl h-8 w-20  mb-11 ml-72'>Tweets</button>
                </div>
                {/* <Routes>
        ...
        <div className='w-1/3 Trendlist'>
          <div className='TrendlistItems_input flex'>
            <TrendslistItems icon={"./src/assets/images/Menu-Button/Icons/rechercher.png"} />
            <input className='TrendslistItems_input' placeholder='Search Twitter' type="text" />
          </div>


          <div className='Trendlist_Cont'>
